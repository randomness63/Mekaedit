...
public class BPMLLAlgorithm2 {
    ...
    //added additional argument for dropout -J
    ...
    //return and allow dropChance to be edited somewhere, right now only has a default -J
    public double learn(double[] inputPattern, double[] expectedLabels, double learningRate){
    	return learn(inputPattern, expectedLabels,learningRate, 0.8);
    }
