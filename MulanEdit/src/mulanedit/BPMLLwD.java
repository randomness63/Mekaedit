...
public class BPMLLwD extends MultiLabelLearnerBase {
    ...
    private double dropoutProportion = 1;
    private float neuronFraction = 0.2f;
    ...
    //edited NeuralNet type -J
    private ExtendedNeuralNet model;
     ...
     */
    public BPMLLwD(long randomnessSeed) {
    ...
    /**
     * Gets the proportion of dropout for the current training run.
     * Default value is one.
     * @return the proportion of dropout for the current training run
     */
    public double getDropoutProportion(){
    	return dropoutProportion;
    }

    /**
     * Sets the proportion of dropout for the current training run.
     */
    public void setDropoutProportion(double dropoutProportion){
    	this.dropoutProportion = dropoutProportion;
    }
    
    /**
     * Gets the size of the network based on the number of neurons.
     * Default value is 0.2
     * @return the proportion of input vector that should be used for the hidden layer
     */
    public float getNeuronProportion(){
    	return neuronFraction;
    }
    
    /**
     * Sets the size of the hidden layer as a proportion of the input vector size.
     */
    public void setNeuronProportion(float neuronFraction){
    	this.neuronFraction = neuronFraction;
    }
    ...
    protected void buildInternal(final MultiLabelInstances instances) throws Exception {
        ...
        //edited algorithm type to use Alg2
        BPMLLAlgorithm2 learnAlg = new BPMLLAlgorithm2(model, weightsDecayCost, networkTopology);
        ...
        for (int epoch = 0; epoch < epochs; epoch++) {
            ...
            for (int index = 0; index < numInstances; index++) {
                ...
                double result = learnAlg.learn(trainPair.getInput(), trainPair.getOutput(), learningRate, dropoutProportion);
    ...
    public String globalInfo() {
        return "The implementation of Back-Propagation Multi-Label Learning "
                ...
                + "built by {@link BPMLLAlgorithm2} from given training data set.";
    }
    ...
    //changed return type to ExtNN instead of NN -J
    private ExtendedNeuralNet buildNeuralNetwork(int inputsDim) {

        int[] networkTopology;
        if (hiddenLayersTopology == null) {
        	//allows for different number of hidden units
            int hiddenUnits = Math.round(neuronFraction * inputsDim);
        ...
        ExtendedNeuralNet aModel = new DropoutNeuralNet(networkTopology, NET_BIAS, ActivationTANH.class, randomnessSeed == null ? null : new Random(randomnessSeed));
